...
## Project Structure
    ...
    ├── test_event_manageme_81066  # Django project configurations
...
1. Clone this repo and `cd test_event_manageme_81066`
...
2. Clone this repo and `cd test_event_manageme_81066`
