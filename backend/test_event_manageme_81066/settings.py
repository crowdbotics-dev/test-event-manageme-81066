"""
Django settings for test_event_manageme_81066 project.
...
ROOT_URLCONF = 'test_event_manageme_81066.urls'
...
WSGI_APPLICATION = 'test_event_manageme_81066.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_event_manageme_81066 API",
    "DESCRIPTION": "API documentation for test_event_manageme_81066 App",
    "VERSION": "v1",
}
